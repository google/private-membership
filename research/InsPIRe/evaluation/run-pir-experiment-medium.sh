RESULTS_DIR="results/pir-experiments/v15/medium"
mkdir -p $RESULTS_DIR
...
configs=(
  "3 $((64 * 8))"  # log_db_num_items = 3, item_size_bits = 32 KB
  "12 $((64 * 8))" # log_db_num_items = 12, item_size_bits = 32 KB
  "15 $((64 * 8))" # log_db_num_items = 15, item_size_bits = 32 KB
  "18 $((64 * 8))" # log_db_num_items = 18, item_size_bits = 32 KB
